...
## Table of Contents
<!-- TOC -->autoauto- [FixEval: Execution-based Evaluation of Program Fixes for Competitive Programming Problems](#fixeval-execution-based-evaluation-of-program-fixes-for-competitive-programming-problems)auto- [Table of Contents](#table-of-contents)auto- [Folder Structure](#folder-structure)auto- [Dataset](#dataset)auto        - [Download Project Codenet Dataset (Skip this if you want to run from our preprocessed files)](#download-project-codenet-dataset-skip-this-if-you-want-to-run-from-our-preprocessed-files)auto        - [Download Codenet Metadata](#download-codenet-metadata)auto        - [Download Test Cases](#download-test-cases)auto- [Installation](#installation)auto- [Pre-processing (Skip this if you want to run from our preprocessed files)](#pre-processing-skip-this-if-you-want-to-run-from-our-preprocessed-files)auto        - [Create Language Specific Data (Skip this part if you just want to download our version)](#create-language-specific-data-skip-this-part-if-you-just-want-to-download-our-version)auto        - [Split The Data (Skip this if you want to run from our preprocessed files)](#split-the-data-skip-this-if-you-want-to-run-from-our-preprocessed-files)auto- [Download Preprocessed Data](#download-preprocessed-data)auto        - [Download and unzip our preprocessed java dataset](#download-and-unzip-our-preprocessed-java-dataset)auto        - [Download and unzip our preprocessed python dataset](#download-and-unzip-our-preprocessed-python-dataset)auto- [Training and Evaluation](#training-and-evaluation)auto        - [Training the model and evaluating on the dataset](#training-the-model-and-evaluating-on-the-dataset)auto- [Evaluation](#evaluation)auto        - [Evaluate on Execution](#evaluate-on-execution)auto        - [Lets generate the test file](#lets-generate-the-test-file)auto        - [pre-preprocess the test file that contains all tokenized and detokenized source , target and prediction on all beam size](#pre-preprocess-the-test-file-that-contains-all-tokenized-and-detokenized-source--target-and-prediction-on-all-beam-size)auto        - [Finally lets run the code to execute and evaluate](#finally-lets-run-the-code-to-execute-and-evaluate)auto        - [use results.py to get the results](#use-resultspy-to-get-the-results)auto- [Benchmarks](#benchmarks)auto        - [Match based metrics](#match-based-metrics)auto        - [Execution based metrics](#execution-based-metrics)auto- [License](#license)auto- [Citation](#citation)autoauto<!-- /TOC -->
