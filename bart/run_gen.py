...
from bart.utils import get_filenames, get_elapse_time, load_and_cache_gen_data
from bart.configs import add_args, set_seed, set_dist
...
def main():
    ...
    model = PLBartForConditionalGeneration.from_config(config)
